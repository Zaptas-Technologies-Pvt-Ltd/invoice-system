...
export default function TaxReports() {
    ...
    const exportInvoiceAll = async()=>{
        const response = await axios.get('exportExcelxlsxAll?fromdate='+FromDates+'&todate='+ToTODates+'&saccode='+SACCodeFilts);
      ...
      const exportInvoiceTaxReport = async()=>{
        const response = await axios.get('exportExcelxlsxTaxReport?fromdate='+FromDates+'&todate='+ToTODates+'&saccode='+SACCodeFilts);
      ...
      const exportInvoiceSACCode = async()=>{
        const response = await axios.get('exportExcelxlsxSACCode?fromdate='+FromDates+'&todate='+ToTODates+'&saccode='+SACCodeFilts);
