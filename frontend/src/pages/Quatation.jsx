...
export default function Quoation() {
  ...
  return (
    <div className="flex flex-col gap-4 w-full">
      ...
      <div className='card p-3'>
        <h1 className='text-lg'> Affiliate Client Details (Quotation)</h1>
        <hr />
        ...
        <div className="button-section">
          <button type="submit" className="flex flex-nowrap text-white text-bg-color active:bg-purple-200 font-bold uppercase text-sm px-4 py-2.5 rounded w-[8rem] shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1">Create Quotation</button>
        </div>
      </form>
    </div>
