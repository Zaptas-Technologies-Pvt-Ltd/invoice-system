  ...
  return (
    <div className="container mx-auto">
      ...
      <div className='card p-3'>
        <h1 className='text-lg'>Annual Maintenance Charges (AMC)  </h1>
        <hr />
            ...
            <div className="flex w-[60rem] mb-6 md:grid-cols-3 mt-6">
              ...
              <div className="flex">
                <div className='w-[21rem]'>
                  <label for="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Select Details</label>
                </div>
                <div className='w-[21rem]'>
                  <label for="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">AMC Rate</label>
                </div>
                <div>
                  <label for="last_name" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">AMC Remark</label>
                </div>
              </div>
             { (poData.length !==0)? 
